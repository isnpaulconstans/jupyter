...
def add_course(args):
    ...
    print("---------------------------------------------------------")
    os.system(f"addgroup eleves_{course}_{ANNEE}")
...
def del_course(args):
    ...
    os.system(f"rm -rf /srv/nbgrader/exchange/{course}")
...
def main():
    ...
    parser_import.add_argument('file', help='file to import (last name, first name, student name, course name, password)')
